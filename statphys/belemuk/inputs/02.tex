...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.45\textwidth]{img/sem2im1.pdf}
    %\caption{}
    %\label{fig:}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{img/sem2im2.pdf}
    %\caption{}
    %\label{fig:}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{img/sem2im3.pdf}
    %\caption{}
    %\label{fig:}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{img/sem2im4.pdf}
    %\caption{}
    %\label{fig:}
\end{figure}
...
\begin{enumerate}
	...
	\item $c$ -- имеет максимум, если число уровней ограничено, значит он есть (теплоёмкость Шоттки);
	\item $T \to \infty$, то $c \sim 1/T^2$ (красная асимптота).
\end{enumerate}
