...
\end{equation*}
где $\mathbb{B}$ -- функция БРиллюэна с разложением $\mathbb{B}(x) = \alpha x - \beta x^3$, $\alpha = (S+1)/3S$, $\beta = \alpha (2 S^2 + 2 S + 1) / 30 S^2$. 
...
\begin{equation*}
	\Delta_- = \delta n \cdot \frac{\delta n}{D(\varepsilon_F)},
\end{equation*}
тогда поляризация свободных электронов будет происходить при 
\begin{equation*}
	U_0 D(\varepsilon_F) > 1,
\end{equation*}
